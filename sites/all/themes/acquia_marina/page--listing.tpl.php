...
?>
  ...
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div class="preface-top-outer"><div id="preface-top-inner" class="preface-top-inner inner clearfix">
          </div><?php print render($page['preface_top']); ?></div>
                      ...
                      <div id="content-group-inner" class="content-group-inner inner">
                        ...
                        <div id="content-region" class="content-region region nested">
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <?php //if ($title): ?>
                            <?php if (false): ?>
                            <h1 class="title gutter"><?php print $variables['node_content']['field_address'][0]['#markup']; ?></h1>
                            <?php endif; ?>
