...
<?php //foreach ($fields as $id => $field): ?>
    <div class="listing_row">
    	...
    	<div class="listing_row_address"><?php print $fields['field_address']->content;?></div>
    	<div class="listing_row_location"><?php print $fields['field_city']->content;?></div>
    	<div class="listing_row_price"><?php print $fields['field_price']->content;?></div>
    	<div class="listing_row_description"><?php print $fields['body']->content;?></div>
